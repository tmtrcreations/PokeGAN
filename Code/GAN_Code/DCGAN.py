...
parser.add_argument('--input_folder', default='../../Images/Training_Images', help='input folder')
parser.add_argument('--output_folder', default='../../Images/Generated_Sprites/', help='output folder')
...
parser.add_argument('--n_workers', type=int, default=4, help='Number of subprocess to use to load the data. Use at least 2 or the number of cpu cores - 1.')
